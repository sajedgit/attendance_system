...
(1, 'admin', '$2y$10$jUuOVshfvZMjVLZqrz55TubNsYCsHg8YQ2ULUGdVMEePZl9vaRMcW', 'Harry', 'Den', '', 'male6.jpg', '2018-04-30');
...
INSERT INTO `employees` (`id`, `employee_id`, `email`, `firstname`, `lastname`, `address`, `birthdate`, `contact_info`, `gender`, `department_id`, `position_id`, `schedule_id`, `photo`, `created_on`) VALUES
(1, 'ABC123456789', 'ABC123456789', 'Christine', 'Smith', 'Brgy. Mambulac, Silay City', '2018-04-02', '09000035719', 'Female', 0, 1, 1, 'desktop.jpg', '2018-04-28'),
